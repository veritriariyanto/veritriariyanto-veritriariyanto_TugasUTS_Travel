...
<head>
    ...
    <title>Data Destinations Dashboard</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h2 class="text-white h3">Data Destinations</h2>
                </div>
                ...
                <div class="card bg-dark border-0 text-light mb-4">
                            ...
                            <tbody>
                                @forelse ($destinations as $destination)
                                    <tr>
                                        ...
                                        <td>{{ 'Rp ' . number_format($destination->htm, 2, ',', '.') }}</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <div class="alert alert-danger">
                                                Data Destinations belum Tersedia.
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                    ...
                    {{ $destinations->links('pagination.custom-pagination') }}
                    <!-- Pagination -->
                </div>
            </main>
        </div>
